...
--
ALTER TABLE `depositor`
  ADD CONSTRAINT `depositor_ibfk_1` FOREIGN KEY (`account_number`) REFERENCES `account` (`account_number`),
  ADD CONSTRAINT `depositor_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`);

...
'q1.1 - Retrieve the names of all students in the "ComputerSci" Department?'

SELECT Name
FROM students
WHERE students.Department = 'ComputerSci';

'q1.2 - List all courses offered by "Mathematics Department?'

SELECT CourseName
FROM courses
WHERE courses.Department = 'Mathematics';

'q1.3 - Find the avg GPA of students in the "Physics" Department?'

SELECT ROUND(AVG(students.GPA), 2)
FROM students
WHERE students.Department = 'Physics';

'q1.4 - Display the names of students who are older than 21 years?'

SELECT *
FROM students s
WHERE s.Age < 21;

'q1.5 - Retrive the details of courses with more than 3 credits?'

SELECT *
FROM courses c
WHERE c.Credits > 3;

'q1.6 - Find the names and GPAs of students with a GPA greater than 3.5?'
...
'q1.7 - List of all students and their corresponding department?'
...
'q1.8 - Display the CourseID and CourseName for courses offered by the "ComputerSci" Department?'
...
'q1.9 - Find the total numbers of students in the "Mathematics" Department?'
